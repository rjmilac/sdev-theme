<?php
    ...
    class Block{
        ...
        public function getCategories($exclude_uncategorised = true, $orderby = 'description', $order = 'ASC'){
        ...
        public function loadBlockTemplate($template){
            $template = locate_template('views/blocks/'.$template.'.php');
            if($template){
                include($template); 
                return true;
            }
